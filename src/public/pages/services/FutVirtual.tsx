        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div>
            <p className="text-gray-600 mb-4 text-sm text-justify">
              Descarga aquí el formato de FUT (Formulario Único de Trámite) y
              complétalo con tus datos. Una vez llenado, podrás adjuntarlo en
              nuestra plataforma virtual para registrar tu solicitud de manera
              rápida y segura.
            </p>
          </div>
