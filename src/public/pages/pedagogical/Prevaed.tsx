        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2">
            ...
            <div className="bg-white rounded-2xl shadow-xl shadow-blue-100/50 p-8 border border-blue-100/20 backdrop-blur-sm">
              ...
              <p>Es un programa multisectorial a nivel nacional que aborda el problema específico relacionado con la población y sus medios de vida vulnerables ante el impacto de amenazas con secuelas de desastre.</p>
            </div>
          </div>
