      ...
      <div className="bg-gradient-to-r from-amber-600 via-orange-600 to-red-600 to-blue-600 text-white py-16 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <h1 className="text-4xl font-bold tracking-tight">Intercultural Bilingüe</h1>
          </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2">
            ...
            <div className="bg-white rounded-2xl shadow-xl shadow-blue-100/50 p-8 border border-blue-100/20 backdrop-blur-sm">
              ...
              <p> Es el área de atención responsable, entre otras; de planificar, ejecutar y evaluar las acciones de diversificación curricular con pertinencia cultural y lingüística y promover su construcción de acuerdo al contexto; así como la de planificar, supervisar, monitorear, asesorar, efectuar el seguimiento y evaluar el desarrollo de los aspectos técnico pedagógicos, realizando las coordinaciones y ejecutando las actividades permanentes para el mejoramiento de los aprendizajes con enfoque Intercultural Bilingüe.</p>
