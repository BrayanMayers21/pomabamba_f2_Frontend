    ...
    <div className="bg-gray-100 min-h-screen px-4 py-8 mt-20">
      <div className="container mx-auto">
        ...
        <h3 className="text-gray-700 font-semibold mb-4 uppercase">
          Son objetivos fundamentales de la COORDINADORA DE PRONOEI:
        </h3>
        <p className="text-gray-700 mb-4 text-sm">
          Además de buscar ampliar la cobertura de atención para niños y niñas
          de 3 a 5, PRONEI tiene los siguientes objetivos específicos:
        </p>
