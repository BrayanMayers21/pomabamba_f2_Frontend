      ...
      <div className="bg-gradient-to-r from-amber-600 via-orange-600 to-red-600 to-blue-600 text-white py-16 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <h1 className="text-4xl font-bold tracking-tight">Educación y Cultura</h1>
          </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2">
            ...
            <div className="bg-white rounded-2xl shadow-xl shadow-blue-100/50 p-8 border border-blue-100/20 backdrop-blur-sm">
              ...
              <p> Esta área de atención tiene entre algunas de sus responsabilidades; programar actividades no formales con población escolar trabajadora, organizar, coordinar y ejecutar actividades culturales con la población escolar, participar en comisiones y/o reuniones interinstitucionales para la realización de actividades y eventos culturales, participar en la formulación y coordinación de programas Escuelas del Aire, actividades de carácter recreativo, cultural y campañas educativos, etc.  </p>
